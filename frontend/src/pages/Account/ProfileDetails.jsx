          ...
          <div className="h-full">
            <div className="h-full flex flex-col space-y-5">
              ...
              <div className="flex items-stretch flex-col sm:items-center sm:flex-row gap-5 border border-grayLight rounded-lg p-3 relative">
                ...
                />
                <div>
                  <h4 className="text-primary-text text-xl font-bold text-wrap">
                    {_this?.user?.first_name} {_this?.user?.last_name}
                  </h4>
                  <h5 className="text-gray-medium text-md font-normal py-1 break-all">
                    {_this?.user?.email}
                  </h5>
                  <h5 className="text-gray-medium text-sm font-normal text-wrap break-all">
                    {_this?.user?.bio}
                  </h5>
                </div>
                <MdOutlineEdit
